...
import { getAllReminders, deleteReminder, markReminderComplete, saveReminder } from '../utils/storage';
...
export default function HomeScreen() {
  ...
  const handleIncomplete = async (id: string) => {
    ...
    const reminderToUpdate = reminders.find(r => r && r.id === id);
    if (!reminderToUpdate) return;
    
    // Update the reminder
    const updatedReminder = { ...reminderToUpdate, completed: false };
    
    // Save to storage using the existing saveReminder function
  ...
  return (
    <View style={styles.container}>
      <Text style={styles.header}>Campus Reminders</Text>
